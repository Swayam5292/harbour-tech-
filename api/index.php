...
<body>
  ...
  <div class="hero-global-wrapper">
    ...
    <section class="hero perspective-container">
      ...
      <div class="hero-right preserve-3d" data-aos="fade-left" data-aos-duration="1000">
        <div class="hero-code-card" data-tilt data-tilt-max="12">
          ...
          <div class="code-body">
            <div class="code-line"><span class="ck">const</span> <span class="cv">client</span> = { <span class="cp">goal</span>: <span class="cs">"Scale business"</span> };</div>
            <div class="code-line"><span class="ck">await</span> <span class="cf">harbourTech</span>.<span class="cf">build</span>(client);</div>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="metrics-bar" data-aos="fade-up">
      ...
      <div class="metric-divider"></div>
      <div class="metric-item"><div class="metric-num" data-count="15">0+</div><div class="metric-label">Team Members</div></div>
    </div>
  </div>
      ...
      <div class="about-grid">
        ...
        <div class="about-right">
          ...
          <div class="about-tags">
            <span>ISO Certified</span><span>AWS Partner</span><span>24/7 Support</span><span>Agile Process</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section section--alt" id="process">
    <div class="page-wrapper">
      <div class="section-header" data-aos="fade-up">
        ...
        <p style="color: var(--text-muted); font-size: 15px; margin-top: 16px; max-width: 480px; margin-left: auto; margin-right: auto; line-height: 1.7;">
          A proven 4-phase process that takes your idea from concept to a live, revenue-generating product.</p>
      </div>
      <div class="process-grid">
        <div class="process-step" data-aos="fade-up" data-aos-delay="100">
          <div class="process-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><path d="m21 21-4.3-4.3"></path></svg></div>
          <div class="process-num">01</div><div class="process-title">Discovery</div>
        ...
        <div class="process-step" data-aos="fade-up" data-aos-delay="200">
          <div class="process-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 19l7-7 3 3-7 7-3-3z"></path><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"></path></svg></div>
          <div class="process-num">02</div><div class="process-title">Design & Blueprint</div>
        ...
        <div class="process-step" data-aos="fade-up" data-aos-delay="400">
          <div class="process-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 14 4-4 4 4"></path><path d="M16 10v11"></path></svg></div>
          <div class="process-num">04</div><div class="process-title">Launch & Scale</div>
      ...
      <div class="estimator-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px;">
        <div class="estimator-form">
          ...
          <div class="form-row-2">
            <div class="form-group"><label>Industry</label><select id="estimatorIndustry"><option value="">Select industry...</option><option>E-Commerce</option><option>Healthcare</option><option>FinTech</option><option>SaaS</option></select></div>
            <div class="form-group"><label>Budget Range</label><select id="estimatorBudget"><option value="">Select range...</option><option>₹25K - ₹50K</option><option>₹50K - ₹1.5L</option><option>₹1.5L - ₹5L</option></select></div>
          </div>
          <div class="form-group"><label>Priority Features</label><input type="text" id="estimatorFeatures" placeholder="e.g., Payment, Chat, Admin"></div>
          <button class="btn-primary w-full" id="estimateBtn" onclick="generateEstimate()">Generate AI Estimate</button>
        </div>
        <div class="estimator-result" id="estimatorResult" style="background:var(--card-bg); border:1px solid var(--card-border); padding:30px; border-radius:24px; min-height:300px;">
  ...
  <section class="section" id="faq">
    <div class="page-wrapper">
      ...
      <div class="faq-list" data-aos="fade-up">
        <div class="faq-item"><div class="faq-question" onclick="toggleFaq(this)"><span class="faq-q-text">How long does a typical project take?</span><span class="faq-chevron">▼</span></div><div class="faq-answer"><div class="faq-answer-inner">Timelines vary by complexity. Simple websites take 2-4 weeks. Full-stack applications typically take 6-12 weeks. Enterprise-grade platforms with AI integrations can take 3-5 months.</div></div></div>
        <div class="faq-item"><div class="faq-question" onclick="toggleFaq(this)"><span class="faq-q-text">Do you offer support after delivery?</span><span class="faq-chevron">▼</span></div><div class="faq-answer"><div class="faq-answer-inner">Yes. All plans include a post-launch support window — 1 week for Starter, 30 days for Growth. Enterprise clients get 24/7 priority support.</div></div></div>
        <div class="faq-item"><div class="faq-question" onclick="toggleFaq(this)"><span class="faq-q-text">Can I see progress during development?</span><span class="faq-chevron">▼</span></div><div class="faq-answer"><div class="faq-answer-inner">Absolutely. We work in 2-week Agile sprints and schedule a demo call at the end of each sprint. You'll have access to a staging environment.</div></div></div>
        <div class="faq-item"><div class="faq-question" onclick="toggleFaq(this)"><span class="faq-q-text">What technologies do you specialize in?</span><span class="faq-chevron">▼</span></div><div class="faq-answer"><div class="faq-answer-inner">React, Next.js, Node.js, Python, TypeScript, PostgreSQL, MongoDB, Docker, Kubernetes, AWS, GCP, and Azure.</div></div></div>
        <div class="faq-item"><div class="faq-question" onclick="toggleFaq(this)"><span class="faq-q-text">Is the Starter plan suitable for a startup MVP?</span><span class="faq-chevron">▼</span></div><div class="faq-answer"><div class="faq-answer-inner">Yes — the Starter plan is specifically designed for MVPs and validation-stage products.</div></div></div>
        <div class="faq-item"><div class="faq-question" onclick="toggleFaq(this)"><span class="faq-q-text">Do you sign NDAs?</span><span class="faq-chevron">▼</span></div><div class="faq-answer"><div class="faq-answer-inner">Yes, always. We sign a mutual NDA before any discovery call.</div></div></div>
      </div>
    </div>
  </section>
      ...
      <div class="contact-grid">
        ...
        <div class="contact-form-wrap">
          ...
          <div style="margin-bottom:20px; padding:15px; border-radius:10px; background:var(--card-bg); border:1px solid var(--card-border);">
            <div style="color:var(--accent2); font-weight:700;">PHP Validation Results:</div>
          ...
          <form method="POST" action="index.php#contact" id="contactForm">
            ...
            <div class="form-row-2">
              <div class="form-group"><label>Phone</label><input type="tel" name="user_phone" required value="<?php echo htmlspecialchars($post_phone); ?>"></div>
              <div class="form-group">
                <label>Service</label>
                <select name="service_type">
                  <option>Web Development</option><option>Cloud Solutions</option><option>AI &amp; Analytics</option>
                </select>
              </div>
            </div>
    ...
    <div class="page-wrapper">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>Building modern, scalable digital solutions for businesses that lead.</p>
        </div>
        <div class="footer-col"><h6>Services</h6><a href="#services">Web Dev</a><a href="#services">Cloud</a></div>
        <div class="footer-col"><h6>Company</h6><a href="#about">About</a><a href="#contact">Contact</a></div>
      </div>
      <div class="footer-bottom"><span>&#169; 2026 Harbour Tech Solutions &middot; All Rights Reserved</span></div>
    </div>
  </footer>

  <!-- BACK TO TOP & CHAT BOT (FULLY RESTORED) -->
